<%-- 
    Document   : indexByCateId
    Created on : Jun 7, 2019, 5:13:28 PM
    Author     : Hide
--%>
...
<div class="w3l_banner_nav_right">
    <div class="w3ls_w3l_banner_nav_right_grid">
        ...
        <div class="w3ls_w3l_banner_nav_right_grid1" style="padding:10px 30px">
            <h6 style="margin-left: 30px">${title}</h6>
            <c:forEach items="${pByCateId}" var="b">
            ...
            <div class="text-center">
                <tag:PaginationHandle count="${total}" uri="productByCategoryId.htm" offset="${offset}" steps="8" next="&raquo;" previous="&laquo;"/>
            </div>
        </div>
    </div>
</div>
