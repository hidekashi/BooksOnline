<%-- 
    Document   : offerProduct
    Created on : Jul 5, 2019, 4:20:10 PM
    Author     : Hide
--%>
...
<jsp:include page="navbar.jsp" flush="true"></jsp:include>
    <div class="w3l_banner_nav_right">
        <div class="w3ls_w3l_banner_nav_right_grid">
            ...
            <c:forEach items="${lstOrderPro}" var="b">
            ...
            <div class="text-center">
                <tag:PaginationHandle count="${total}" uri="offerProduct.htm" offset="${offset}" steps="8" next="&raquo;" previous="&laquo;"/>
            </div>
        </div>
    </div>
</div>
