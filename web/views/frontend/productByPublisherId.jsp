<%-- 
    Document   : productByPulisherId
    Created on : Jun 9, 2019, 3:43:59 PM
    Author     : Hide
--%>
...
<div class="w3l_banner_nav_right">
    <div class="w3ls_w3l_banner_nav_right_grid">
        ...
        <div class="w3ls_w3l_banner_nav_right_grid1" style="padding:10px 30px">
            ...
            <c:forEach items="${pByPubId}" var="b">
            ...
            <div class="text-center">
                <tag:PaginationHandle count="${total}" uri="productByPublisherId.htm" offset="${offset}" steps="8" next="&raquo;" previous="&laquo;"/>
            </div>
        </div>
    </div>
</div>
