<%-- 
    Document   : search
    Created on : Jul 4, 2019, 3:38:47 PM
    Author     : Hide
--%>
...
<jsp:include page="navbar.jsp" flush="true"></jsp:include>
    <div class="w3l_banner_nav_right">
        <div class="w3ls_w3l_banner_nav_right_grid">
            ...
            <c:if test="${listSearch.size()==0 || listSearch == null}">
                <p style="color: red;">${searchMes}</p>
            </c:if>
            <c:if test="${listSearch.size()>0}">
                <c:forEach items="${listSearch}" var="b">
                                    ...
                                    <div class="snipcart-item block" >
                                        <div class="snipcart-thumb">
                                            ...
                                            <div class="snipcart-details top_brand_home_details">
                                                ...
                                                <button class="btn-transparent pull-left" type="submit">Thêm vào giỏ</button>
            ...
            <div class="text-center">
                <%--<tag:PaginationHandle count="${totalSearch}" uri="search.htm" offset="${offset}" steps="8" next="&raquo;" previous="&laquo;"/>--%>
                <tag:PaginOderDetail count="${totalSearch}" uri="search.htm?name=${key}" offset="${offset}" steps="8" next="&raquo;" previous="&laquo;"/>
            </div>
        </div>
    </div>
</div>
