<%-- 
    Document   : productByAuthorId
    Created on : Jun 9, 2019, 3:43:15 PM
    Author     : Hide
--%>
    ...
    <div class="w3ls_w3l_banner_nav_right_grid">
        ...
        <div class="w3ls_w3l_banner_nav_right_grid1" style="padding:10px 30px">
            ...
            <div class="text-center">
                <tag:PaginationHandle count="${total}" uri="productByAuthorId.htm" offset="${offset}" steps="8" next="&raquo;" previous="&laquo;"/>
            </div>
        </div>
    </div>
</div>
